...
ICON_SOURCE_PATH = (
    "/Users/wleitner/Downloads/Gemini_Generated_Image_u6lsy9u6lsy9u6ls.png"
)
WORDMARK_SOURCE_PATH = (
    "/Users/wleitner/Downloads/Gemini_Generated_Image_s25ymws25ymws25y.png"
)
...
def process_single_image(source_path, outputs):
    ...
    for output_def in outputs:
        if output_def == "favicon":
            ...
            img.save(
                os.path.join(OUTPUT_DIR, "favicon.ico"), format="ICO", sizes=icon_sizes
            )
        else:
