...
vi.mock('../services/api', () => ({
  ...
  userApi: {
    ...
    getScoringConfig: vi.fn().mockResolvedValue({
      ...
      duration_multiplier: {},
       age_factor: { enabled: true, multiplier_per_unit: 0.01, unit: 'days', max_multiplier: 1.5 },
       due_date_proximity: { enabled: false, unit: 'days', multiplier_per_unit: 0.02, max_multiplier: 1.5 },
